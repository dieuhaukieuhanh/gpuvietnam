...
| 1.8 | Dashboard tối thiểu: trạng thái Job/Attempt | [B1_8_DASHBOARD_JOBS.md](./B1_8_DASHBOARD_JOBS.md) + `DashboardJobsCard` + `GET /api/dashboard/jobs` | User thấy queued / running / failed / retry |
