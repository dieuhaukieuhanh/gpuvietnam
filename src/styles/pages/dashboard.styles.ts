export const styles = `:root {
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .wallet-service-card-head {
            display: flex;
            align-items: flex-start;
            gap: 12px;
        }
        .wallet-service-card-icon {
            font-size: 24px;
            line-height: 1;
            flex-shrink: 0;
        }
        .wallet-service-card-title {
            font-size: 15px;
            font-weight: 700;
            color: var(--text-primary);
            margin: 0 0 4px;
        }
        .wallet-service-card-desc {
            font-size: 13px;
            color: var(--text-secondary);
            margin: 0;
            line-height: 1.45;
        }
        .wallet-service-card-actions {
            display: flex;
            flex-wrap: wrap;
            gap: 8px;
            margin-top: auto;
        ...
        .wallet-service-card-link:hover {
            border-color: rgba(79, 142, 247, 0.45);
            background: var(--bg-card-hover);
        }
        .wallet-service-card-link.primary {
            border-color: rgba(79, 142, 247, 0.35);
            background: rgba(79, 142, 247, 0.12);
            color: var(--accent-blue);
        }
        .wallet-service-card-link.primary:hover {
        ...
        .dashboard-server-badges-slot {
            min-height: 0;
            margin-top: 8px;
        }
        .dashboard-server-card--session .dashboard-server-badges-slot {
            min-height: 32px;
        }
        .dashboard-server-card--session .dashboard-server-actions-slot {
            min-height: 56px;
        }
        ...
        .dashboard-session-timer-block {
            text-align: center;
            margin-bottom: 12px;
        }
        .dashboard-session-timer--live {
            font-size: 32px;
            color: var(--text-primary);
        }
        .dashboard-session-timer--paused {
            color: var(--accent-orange);
        }
        .dashboard-session-timer--muted {
            opacity: 0.38;
            color: var(--text-secondary);
        }
        .dashboard-session-timer--hidden {
            display: none;
        }
        .dashboard-session-stat-strong {
            color: var(--accent-blue);
            font-weight: 600;
        }
        .dashboard-session-status-line {
            font-size: 13px;
            color: var(--text-secondary);
            text-align: center;
            margin: 0 0 8px;
        }
        .dashboard-session-billing-note {
            font-size: 12px;
            color: var(--accent-blue);
            text-align: center;
            margin: 0 0 12px;
        ...
        .dashboard-session-callout--warn {
            color: var(--accent-orange);
            background: rgba(245, 158, 11, 0.08);
            border-color: rgba(245, 158, 11, 0.2);
        }
        .dashboard-session-callout--error {
            color: var(--accent-red);
            background: rgba(239, 68, 68, 0.08);
            border-color: rgba(239, 68, 68, 0.2);
        }
        .dashboard-session-alert {
            margin: 0 14px 14px;
            padding: 10px 12px;
            border-radius: var(--radius-md);
            font-size: 12px;
        ...
        .dashboard-session-alert--danger {
            background: rgba(239, 68, 68, 0.1);
            border: 1px solid rgba(239, 68, 68, 0.25);
            color: #fca5a5;
        }
        .dashboard-session-alert--warning {
        ...
        .dashboard-boot-step--done { color: var(--accent-green); }
        .dashboard-boot-step--active { color: var(--text-primary); font-weight: 500; }
        .dashboard-boot-step-icon {
            width: 18px;
            flex-shrink: 0;
            text-align: center;
        }
        .dashboard-plan-session-ribbon {
            font-size: 12px;
            color: var(--accent-blue);
            background: rgba(79, 142, 247, 0.08);
